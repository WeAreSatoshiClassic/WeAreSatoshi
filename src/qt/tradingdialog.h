...
private slots:
    ...
    void on_BuyICB_clicked();
    void on_SellICBBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputICB_textChanged(const QString &arg1);
    ...
    QString BuyICB(QString OrderType, double Quantity, double Rate);
    QString SellICB(QString OrderType, double Quantity, double Rate);
